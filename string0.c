...
/**
 * atoiii - obtain integer from string
 * @string: string
 * Return: number or zero
 */

int atoiii(char *string)
{
	unsigned int r = 0;
	int index, s = 1, f = 0, o;
...
/**
 * Alpha_check - determines alpha
 * @charac: char
 * Return: one or zero
 */

int Alpha_check(int charac)
{
...
/**
 * EpuT - standard error printing
 * @charac: chars
 * Return: one or negative one
 */

int EpuT(char charac)
{
